...
export default function StaffSalaryReport() {
  ...
  const loadSalaries = (month?: string) => {
    dispatch(fetchSalaries({ userType: 'staff', page: 1, limit: 50, month }));
  };
    ...
    <div className={styles.pageContainer}>
      <div className={styles.tableCard}>
        <div className={styles.tableHeader} style={{ marginBottom: '16px' }}>
          <h2 className={styles.tableTitle}>Staff Paid Salaries</h2>
          ...
          <div className={styles.tableWrapper}>
            <table className={styles.table}>
              ...
              <tbody>
                {salaries.length === 0 ? (
                  <tr>
                    <td colSpan={8} style={{ textAlign: 'center', padding: '24px' }}>No salaries found.</td>
                  </tr>
                ) : (
                  salaries.map((s: any) => (
                    <tr key={s._id}>
