                  ...
                  <td>
                    <div className={styles.actionGroup}>
                      <button 
                        ...
                        onClick={() => onTogglePublish && onTogglePublish(result._id)}
                        title={result.isPublished ? "Unpublish" : "Publish"}
                      >
                         <svg width="16" height="16" fill={result.isPublished ? "#10b981" : "none"} stroke="currentColor" viewBox="0 0 24 24">
